...
public interface IInoreaderClient: IDisposable {
    ...
    /// <param name="includeFolders"><c>false</c> for the response <see cref="Article.FoldersTagsAndStates"/> to only contain system labels like <see cref="StreamId.Starred"/> as well as tags you have added to the article, but not the folder that the article's feed is in, or <c>true</c> to also contain the folder.</param>
    ...
    /// <param name="pagination">The <see cref="PaginatedListResponse.PaginationToken"/> from a prior response to fetch subsequent pages, or <c>null</c> to fetch the first page.</param>
    /// <param name="ascendingOrder"><c>true</c> to sort articles in the response list ascending by <see cref="BaseArticle.CrawlTime"/>, or <c>false</c> to sort them descending.</param>
    /// <param name="includeFolders"><c>false</c> for the response <see cref="Article.FoldersTagsAndStates"/> to only contain tags you have added to the article, but not the folder that the article's feed is in, or <c>true</c> to also contain the folder.</param>
