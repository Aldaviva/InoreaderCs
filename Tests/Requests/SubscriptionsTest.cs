...
public class SubscriptionsTest: ApiTest {
    ...
    public async Task QuickAdd() {
        var request = RequestMocker.MockJsonHttpRequest(verb: HttpMethod.Post, url: new Uri("https://www.inoreader.com/reader/api/0/subscription/quickadd"),
        ...
        SubscriptionCreationResult actual = await Inoreader.Subscriptions.Subscribe(new Uri("https://arstechnica.com/science/feed/"), cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task SlowAdd() {
        var request = RequestMocker.MockHtmlHttpRequest(verb: HttpMethod.Post, url: new Uri("https://www.inoreader.com/reader/api/0/subscription/edit"),
        ...
        await Inoreader.Subscriptions.Subscribe(new Uri("https://arstechnica.com/science/feed/"), "Science!", "Technology", cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task Rename() {
        ...
        await Inoreader.Subscriptions.Rename(new Uri("https://arstechnica.com/science/feed/"), "Science!", cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task AddToFolder() {
        ...
        await Inoreader.Subscriptions.AddToFolder(new Uri("https://arstechnica.com/science/feed/"), "Technology", cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task RemoveFromFolder() {
        ...
        await Inoreader.Subscriptions.RemoveFromFolder(new Uri("https://arstechnica.com/science/feed/"), "Technology", cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task Unsubscribe() {
        ...
        await Inoreader.Subscriptions.Unsubscribe(new Uri("https://arstechnica.com/science/feed/"), cancellationToken: TestContext.Current.CancellationToken);
