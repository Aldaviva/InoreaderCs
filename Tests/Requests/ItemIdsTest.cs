...
public class ItemIdsTest: ApiTest {
    ...
    public async Task ListBriefArticlesInNewsfeed() {
        var request = RequestMocker.MockJsonHttpRequest(HttpMethod.Get,
    ...
    public async Task ListBriefArticlesInFolder() {
        var request = RequestMocker.MockJsonHttpRequest(HttpMethod.Get, new Uri("https://www.inoreader.com/reader/api/0/stream/items/ids?n=1&s=user/-/label/Technology&includeAllDirectStreamIds=true"),
            null,
            """{ "items": [], "itemRefs": [{ "id": "47047259872", "directStreamIds": ["user\/1006195123\/label\/Technology"], "timestampUsec": "1761990925646284" }], "continuation": "2QD6qtUABtAE" }""");
    ...
    public async Task ListBriefArticlesInTag() {
        var request = RequestMocker.MockJsonHttpRequest(HttpMethod.Get, new Uri("https://www.inoreader.com/reader/api/0/stream/items/ids?n=1&s=user/-/label/My%20tag&includeAllDirectStreamIds=true"),
            null,
